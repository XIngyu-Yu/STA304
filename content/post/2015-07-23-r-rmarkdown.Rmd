...
dataset <- read.csv('single_use_takeaway_items_stage_1_1_.csv')
plastic.straws <- dataset$X2.8..Plastic.Straws
reusable.straws <- dataset$X4.5..Reusable.straws..instead.of.disposable.straws
table(plastic.straws)
...
```{r ，message=FALSE, warning=FALSE}
reason <- dataset$X3.5..It.is.a.hassle.to.carry.reusable.items.with.me
table(reason)
```
